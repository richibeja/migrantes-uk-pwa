...
export default function MyTicketsClient({ clubId }: MyTicketsClientProps) {
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <h1 className="text-2xl font-bold text-gold">My Tickets</h1>
        ...
        {ticketsFiltrados.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-400 mb-6">
              {filter === 'todos' 
                ? 'Register your first ticket to get started'
                : `You don't have ${filter} tickets`
              }
            </p>
            {filter === 'todos' && (
              <button
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Draw: {new Date(ticket.datosVerificacion.fechaSorteo).toLocaleDateString()}
                    </p>
                  </div>
                  ...
                  {ticket.verificacion && (
                    <div className="bg-gray-700/50 rounded-lg p-3">
                      ...
                      <div className="text-white text-sm">
                        {ticket.verificacion.comentarios || 'Verified correctly'}
                      </div>
