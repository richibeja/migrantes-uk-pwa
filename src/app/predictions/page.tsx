  ...
  const initializeLotteriesWithRealPredictions = () => {
    ...
    const initialLotteries: Lottery[] = [
      ...
      },
      {
        ...
        jackpot: '£5,000,000',
        nextDraw: new Date(now.getTime() + 3 * 24 * 60 * 60 * 1000).toISOString(),
        predictions: (predictionsByLottery['uk-lotto'] || []).map(pred => ({
          id: pred.id,
          numbers: pred.numbers,
          confidence: pred.confidence,
          specialBall: pred.specialNumbers[0] || null,
        ...
        confidence: predictionsByLottery['uk-lotto']?.reduce((sum, p) => sum + p.confidence, 0) / (predictionsByLottery['uk-lotto']?.length || 1) || 0,
        lastWin: '2025-01-10',
        winAmount: '£3.2M GBP',
      ...
      },
      {
        ...
        jackpot: '£500,000',
        nextDraw: new Date(now.getTime() + 1 * 24 * 60 * 60 * 1000).toISOString(),
        predictions: (predictionsByLottery['thunderball'] || []).map(pred => ({
          id: pred.id,
          numbers: pred.numbers,
          confidence: pred.confidence,
          specialBall: pred.specialNumbers[0] || null,
        ...
        confidence: predictionsByLottery['thunderball']?.reduce((sum, p) => sum + p.confidence, 0) / (predictionsByLottery['thunderball']?.length || 1) || 0,
        lastWin: '2025-01-11',
        winAmount: '£500K GBP',
        logo: '/logos/thunderball.png',
        specialBallName: 'Thunderball',
        specialBallRange: 14,
        totalNumbers: 5,
        specialBallNumbers: 1,
        drawTime: '20:00',
      ...
      },
      {
        ...
        jackpot: '£10,000/month',
        nextDraw: new Date(now.getTime() + 2 * 24 * 60 * 60 * 1000).toISOString(),
        predictions: (predictionsByLottery['set-for-life'] || []).map(pred => ({
          id: pred.id,
          numbers: pred.numbers,
          confidence: pred.confidence,
          specialBall: pred.specialNumbers[0] || null,
        ...
        confidence: predictionsByLottery['set-for-life']?.reduce((sum, p) => sum + p.confidence, 0) / (predictionsByLottery['set-for-life']?.length || 1) || 0,
        lastWin: '2025-01-06',
        winAmount: '£10K/month',
        logo: '/logos/setforlife.png',
        specialBallName: 'Life Ball',
        specialBallRange: 10,
        totalNumbers: 5,
        specialBallNumbers: 1,
        drawTime: '20:00',
      ...
      },
      {
        ...
        jackpot: '£1,000,000',
        nextDraw: new Date(now.getTime() + 4 * 24 * 60 * 60 * 1000).toISOString(),
        predictions: (predictionsByLottery['euromillions-hotpicks'] || []).map(pred => ({
          id: pred.id,
          numbers: pred.numbers,
          confidence: pred.confidence,
          specialBall: null,
        ...
        confidence: predictionsByLottery['euromillions-hotpicks']?.reduce((sum, p) => sum + p.confidence, 0) / (predictionsByLottery['euromillions-hotpicks']?.length || 1) || 0,
        lastWin: '2025-01-05',
        winAmount: '£1M GBP',
        logo: '/logos/hotpicks.png',
        specialBallName: '',
        specialBallRange: 0,
        totalNumbers: 5,
      ...
      },
      {
        ...
        nextDraw: new Date(now.getTime() + 3 * 24 * 60 * 60 * 1000).toISOString(),
        predictions: (predictionsByLottery['baloto'] || []).map(pred => ({
          id: pred.id,
          numbers: pred.numbers,
          confidence: pred.confidence,
          specialBall: pred.specialNumbers[0] || null,
        ...
        confidence: predictionsByLottery['baloto']?.reduce((sum, p) => sum + p.confidence, 0) / (predictionsByLottery['baloto']?.length || 1) || 0,
        lastWin: '2025-01-12',
        winAmount: '$5B COP',
        logo: '/logos/baloto.png',
        specialBallName: 'Superbalota',
        specialBallRange: 16,
        totalNumbers: 5,
        specialBallNumbers: 1,
        isVerified: true,
