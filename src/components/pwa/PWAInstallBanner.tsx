...
export default function PWAInstallBanner({ isVisible, onClose }: PWAInstallBannerProps) {
      ...
      <div className="p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="font-bold text-lg mb-1">¡Instala GanaFácil!</h3>
            <p className="text-sm opacity-90 mb-3">
              Instala la app para acceso rápido, notificaciones y funcionamiento offline
            </p>
